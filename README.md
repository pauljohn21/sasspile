...
> **v0.9.6** — CSS Color 4 现代色彩空间 + W3C 精确转换矩阵 + 色域映射 + slash 分隔符语义 — 5287/11512 (46%) sass-spec.
...
- **sass-spec 兼容**: 5287/11512 (46%) 全量通过（VFS + `===` 分组隔离，更准确），@directives 子目录 329/605 (54%)，core_functions/color 2342/5715 (41%)，manifest 精简只跳过 libsass/non_conformant 弃用目录
